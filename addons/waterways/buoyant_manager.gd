...
@export var buoyancy_force := 50.0 # (float, 0.0, 200.0)
@export var up_correcting_force := 5.0 # (float, 0.0, 20.0)
@export var flow_force := 50.0 # (float, 0.0, 200.0)
@export var water_resistance := 5.0 # (float, 0.0, 30.0)
